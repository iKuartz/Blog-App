...
RSpec.describe 'posts_show_page', type: :system do
  before :all do
    ...
    @comment1 = Comment.create!(author_id: 1, post_id: 5, text: 'Comment-1')
    @comment1 = Comment.create!(author_id: 2, post_id: 5, text: 'Comment-1')
    @comment1 = Comment.create!(author_id: 3, post_id: 5, text: 'Comment-1')

    @like1 = Like.create!(author_id: 1, post_id: 5)
    @like1 = Like.create!(author_id: 2, post_id: 5)
    @like1 = Like.create!(author_id: 3, post_id: 5)
  end
  ...
  context 'testing post#show' do
    ...
    it 'I can see the post title' do
      expect(page).to have_content 'Sample post4'
    end
